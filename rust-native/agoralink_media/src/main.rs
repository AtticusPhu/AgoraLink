...
Defaults:\n\
  ...
  screen-send: fixed mode unchanged; --adaptive-quality off --display-refresh-detect auto --max-fps 60 --enable-high-refresh false --adaptive-min-width 1280 --adaptive-min-height 720 --adaptive-min-fps 30 --adaptive-feedback-ms 1000 --adaptive-upgrade-stable-sec 15 --adaptive-resolution-cooldown-sec 30 --adaptive-fps-cooldown-sec 20 --interactive-lag-guard true\n\
